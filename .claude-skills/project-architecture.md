...
│   │   ├── measure.h/cpp/ui    # 测量
│   │   ├── align/              # 配准工具
│   │   │   ├── align_by_centers.h/cpp
│   │   │   ├── global_registration.h/cpp
│   │   │   ├── fine_registration.h/cpp
│   │   │   └── point_pairs_alignment.h/cpp
│   │   ├── segmentation/       # 分割工具
│   │   │   ├── shape_detection_dialog.h/cpp/ui
│   │   │   ├── morphological_filter_dialog.h/cpp/ui
│   │   │   ├── region_growing_dialog.h/cpp/ui
│   │   │   ├── clustering_dialog.h/cpp/ui
│   │   │   └── supervoxel_dialog.h/cpp/ui
│   │   ├── mesh/               # 网格工具
│   │   │   ├── compute_hull_dialog.h/cpp/ui
│   │   │   ├── extract_boundary_dialog.h/cpp/ui
│   │   │   └── reconstruct_surface_dialog.h/cpp/ui
│   │   └── distance/           # 距离工具
│   │       ├── cloud_cloud_dist_dialog.h/cpp/ui
│   │       ├── cloud_mesh_dist_dialog.h/cpp/ui
│   │       ├── cloud_primitive_dist_dialog.h/cpp/ui
│   │       └── closest_point_set_dialog.h/cpp/ui
│   ├── edit/                   # 编辑工具
│   │   ├── color.h/cpp/ui      # 颜色设置（点云+模型+法线）
...
│   ├── options/                # 选项设置
│   │   ├── displaysettings.h/cpp    # Display Settings 容器对话框
│   │   ├── displaysettings_page.h  # 设置页面基类
│   │   └── displaysettings_colors_page.h/cpp # 颜色设置页（背景色+包围盒）
│   ├── plugins/                # 插件系统
│   │   ├── csfplugin.h/cpp/ui  # 地面点分割
│   │   ├── vegplugin.h/cpp/ui  # 植被分割
│   │   └── changedetectplugin.h/cpp/ui # 变化检测
│   ├── python/                 # Python UI 组件
│   │   ├── python_console.h/cpp # Python 控制台
│   │   └── python_editor.h/cpp # Python 编辑器
│   ├── resources/              # 资源文件
│   │   ├── res.qrc             # Qt 资源文件
...
| ct_algorithm | STATIC | 算法模块，无跨模块共享需求 |
