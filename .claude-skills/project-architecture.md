...
**外部依赖**: Qt5, VTK, PCL, OpenMP, pybind11, Python3, LASlib, CSF
...
│   │   ├── segmentation.h/cpp/ui # 分割
│   │   ├── surface.h/cpp/ui    # 曲面重建
│   │   ├── boundary.h/cpp/ui   # 边界提取
